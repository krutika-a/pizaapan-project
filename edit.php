<?php
            ...
            echo $insertquery="UPDATE information SET
    ...
    echo $query="SELECT * FROM information WHERE id ='".$_GET["id"]."'";
          ...
          <div class="d-grid align-form-map">
            <div class="form-inner-cont">
              <form action="" method="post" class="signin-form">
				...
				<input type="text" style="width:200px" name="firstname" value="<?php echo $user["firstname"]?>" placeholder="first_name" required=""/>
				  
				  <label for="Lastname">Last name</label>
				  <input typr="text" style="width:200px" name="lastname" value="<?php echo $user["lastname"]?>" placeholder="last_name" required="" />
               
               
                  <label for="email">Email</label>
                  <input type="email" name="email" value="<?php echo $user["email"]?>" placeholder="E-mail" required="" />
					<br><br>
				...
				<input type="password" name="password"/><br><br>
				  ...
				  <br> <input type="text" name="contact" value="<?php echo $user["contact"]?>"maxlength="20" style="width:250px">
...
<br>			
				...
				<input typ="text" placeholder="" name="address" value="<?php echo $user["address"]?>"required=""/>
<br><br>
				Gender:
				  <input type="radio" name="gender" <?php if($user["gender"]== "male"){echo "checked";}?> value ="male"/>Male
				  <input type="radio" name="gender" <?php if($user["gender"]== "female"){echo "checked";}?> value="female"/>Female<br><br>
<br>

				  Hobbies:
				  <?php
				  $hobbies=explode(",",$user["hobbies"]);?>
				  cricket<input type="checkbox"<?php if(in_array("cricket",$hobbies)){echo"checked";} ?> name="hobbies[]" value="cricket"> 
				  singing<input type="checkbox" <?php if(in_array("singing",$hobbies)){echo"checked";}?> name="hobbies[]" value="singing"> 
				  Dancing<input type="checkbox" <?php if(in_array("dancing",$hobbies)){echo"checked";}?> name="hobbies[]" value="dancing"> 
				  others<input type="text" name="hobbies[]"  style=width:200px ><br><br>

				  City(Required)*-<select name="city">
				  <option value="nagpur"<?php if($user["city"]=="nagpur"){echo"selected";}?>>Nagpur</option>
				  <option value="mumbai"<?php if($user["city"]=="mumbai"){echo"selected";}?>>>Mumbai</option>
				  <option value="delhi"<?php if($user["city"]=="delhi"){echo"selected";}?>>>Delhi</option>
				  </select><br><br>
