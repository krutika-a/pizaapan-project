...
<head>
  ...
  <title>XYZ a Restaurants Category Responsive Web Template | Home : W3layouts</title>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="modal__content">
          <h2 class="logo"> <span class="fa fa-pie-chart"></span> xYZ</h2>
          <!-- if logo is image enable this   
          <h2 class="logo">
            <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
          </h2> -->
  			...
  			<div class="footers20-content">
  				...
  				<div class="d-grid grid-col-3 grids-content1 bottom-border">
  					<div class="columns copyright-grid">
  						<p class="copy-footer-29">© 2020 XYZ. All rights reserved | Designed by <a
